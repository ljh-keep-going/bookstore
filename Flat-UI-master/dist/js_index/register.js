...
$(document).ready(function(){
    ...
    //生成省下拉列表
    var proHtml="<option value='请选择'>请选择省/城市</option>";
    for(var i in cityList){
        proHtml+='<option value="'+i+'">'+i+'</option>';
    }
    ...
    $("#province").change(function () {
        var pro=$(this).val();
        if(pro!="请选择"){
            var citys=cityList[pro];
            var cityHtml=" <option>请选择城市/地区</option>";
            for(var i in citys){
                cityHtml+='<option value="'+citys[i]+'">'+citys[i]+'</option>';
            }
            $("#city").html(cityHtml);
        }
